...
- [x] Auth + 4-role access control (backend-enforced)
- [x] Course & lesson management (Admin / Content Manager / Instructor)
- [x] Course enrollment + "My Courses"
- [x] Sequential lesson viewing
- [x] Progress tracking (persisted, per student per course)
- [x] Quiz with server-side auto-grading
- [x] Admin panel (user/role management + platform stats)
