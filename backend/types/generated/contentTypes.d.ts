...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'PathShala Course Content Type';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Student Course Enrollment Record';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'PathShala Lesson Content Type';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiProgressProgress extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Student Lesson Completion Record';
...
export interface ApiQuizSubmissionQuizSubmission
  ...
  info: {
    description: 'Graded Student Quiz Submission Record';
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::quiz.quiz'> &
      Schema.Attribute.Private;
    passing_score: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<70>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  info: {
    description: 'Extended user model with LMS role_type, courses, enrollments, progresses, and quiz_submissions';
    displayName: 'User';
    name: 'user';
    pluralName: 'users';
    singularName: 'user';
